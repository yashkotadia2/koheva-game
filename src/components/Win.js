...
function Win(props) {
  ...
  if(props.isWinner){
    return <div className="winner_container">
              <div class="congrats">
                ...
                <div class="el text animated d-none" data-in="zoomOutIn" data-out="zoomOutLeft">CONGRATULATIONS
                </div>
              </div>  
              <div className="won100 d-flex justify-content-center">You Won a $100 Gift Voucher From Koheva!</div>
            </div>;
  }
  else{
    return <div>LOOSER</div>;
  }
}
